...
//		mHListView.setOnItemClickListener(mRegisterViewAdapter);
        ...
        mBitmap = App.Companion.decodeImage(mFilePath);
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == MSG_CODE) {
                if (msg.arg1 == MSG_EVENT_REG) {
                    ...
                    ((App) RegisterActivity.this.getApplicationContext()).mFaceDB.addFace(TimeUtils.Companion.getNowDatetime(), mAFR_FSDKFace, face);
...
//									((App)RegisterActivity.this.getApplicationContext()).mFaceDB.addFace(mEditText.getText().toString(), mAFR_FSDKFace, face);
...
//				convertView.setTag(holder);
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            final Map<String, AFR_FSDKFace> face = ((App) mContext.getApplicationContext()).mFaceDB.mRegister.get(position).mFaceList;
            new AlertDialog.Builder(RegisterActivity.this)
                    .setTitle("删除注册名:" + name)
